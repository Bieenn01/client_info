  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: <Widget>[
        ...
        Divider(),
        // PostDate Section 1 with ExpansionTile
        Card(
          elevation: 5,
          margin: EdgeInsets.symmetric(vertical: 8),
          child: ExpansionTile(
            title: Text('PostDate Section 1'),
            subtitle: Text('This is a description of PostDate Section 1.'),
            trailing: Icon(Icons.arrow_drop_down),
            children: <Widget>[
              ListTile(
                title: Text('Detail 1 for PostDate Section 1'),
              ),
              ListTile(
                title: Text('Detail 2 for PostDate Section 1'),
              ),
            ],
          ),
        ),

        // PostDate Section 2 with ExpansionTile
        Card(
          elevation: 5,
          margin: EdgeInsets.symmetric(vertical: 8),
          child: ExpansionTile(
            title: Text('PostDate Section 2'),
            subtitle: Text('This is a description of PostDate Section 2.'),
            trailing: Icon(Icons.arrow_drop_down),
            children: <Widget>[
              ListTile(
                title: Text('Detail 1 for PostDate Section 2'),
              ),
              ListTile(
                title: Text('Detail 2 for PostDate Section 2'),
              ),
            ],
          ),
        ),

        // Optional: Add more PostDate Sections as needed
        Card(
          elevation: 5,
          margin: EdgeInsets.symmetric(vertical: 8),
          child: ExpansionTile(
            title: Text('PostDate Section 3'),
            subtitle: Text('This is a description of PostDate Section 3.'),
            trailing: Icon(Icons.arrow_drop_down),
            children: <Widget>[
              ListTile(
                title: Text('Detail 1 for PostDate Section 3'),
              ),
              ListTile(
                title: Text('Detail 2 for PostDate Section 3'),
              ),
            ],
          ),
        ),
